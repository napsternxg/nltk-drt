from presuppositions import DRS, DrtLambdaExpression, DrtApplicationExpression, DrtAbstractVariableExpression, DrtNegatedExpression, DrsDrawer
from nltk.sem.logic import BinaryExpression

"""
This is the same file as nltkfixtemporal, but 
I use it with presuppositions.py and presuppositions_test.py
"""
