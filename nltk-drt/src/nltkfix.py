from nltk.sem.drt import DRS, DrtLambdaExpression, BinaryExpression, DrtApplicationExpression, PossibleAntecedents, DrtAbstractVariableExpression, DrtNegatedExpression, DrsDrawer
