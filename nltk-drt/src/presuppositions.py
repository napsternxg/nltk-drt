...
## Demo, tests
#################################
def presuppositions_test (sentence, tester):
    print '==========================', sentence , '=========================='
    expr = tester.parse(sentence, utter=True)
    expr_readings=expr.readings()
    for reading in expr_readings: reading.draw()
...
def presuppositions_sentences(tester):
    ...
    for sentence in sentences[:1]: presuppositions_test(sentence, tester)
...
if __name__ == '__main__':
    ...
    #for sentence in sentences[:1]: presuppositions_test(sentence, tester)
    #for sentence in sentences_2[1:2]: proper_names_test_1(sentence, parser)
    #proper_names_test_2(parser)
    #integration_test(tester)
    #anaphora_main(tester)